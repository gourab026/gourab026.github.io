...
<p class="tag-post-count">
  {%- assign tag_posts = site.tags['python'] -%}
  {{ tag_posts | size }} {% if tag_posts.size != 1 %}posts{% else %}post{% endif %} tagged <strong>#python</strong>
</p>
...
{% else %}
<p class="text-muted">No posts tagged <em>#python</em> yet.</p>
{% endif %}
